...
struct oa_tc6_ncn26010_driver_s
{
...
static int oa_tc6_ncn26010_action(struct oa_tc6_driver_s *dev, enum oa_tc6_action_e action)
{
...
static int oa_tc6_ncn26010_ioctl(struct oa_tc6_driver_s *dev, int cmd,
                                 unsigned long arg)
{
  struct oa_tc6_ncn26010_driver_s *priv = (struct oa_tc6_ncn26010_driver_s *)dev;
...
{
  FAR struct oa_tc6_ncn26010_driver_s *priv = NULL;

  priv = kmm_zalloc(sizeof(*priv));
  if (priv == NULL)
    {
      nerr("Could not allocate data for oa_tc6_ncn26010_driver_s priv\n");
      return NULL;
    }
  ...
  priv->oa_tc6_dev.ops = &g_oa_tc6_ncn26010_ops;
